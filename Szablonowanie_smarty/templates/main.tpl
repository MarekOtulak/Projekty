	...
	<div id="page-wrapper">
		...
		<div id="one" class="spotlight style1 bottom">
			<span class="image fit main">
				<img src="{$app_url}/images/pic02.jpg" alt="" />
			</span>
			<div class="content">
				<div class="container">
					<div class="row">
		...
		<div id="two" class="spotlight style3 left">
			<span class="image fit main bottom"><img src="{$app_url}/images/pic04.jpg" alt="" /></span>
				<div class="content">
...
<script src="{$app_url}/js/jquery.dropotron.min.js"></script>
